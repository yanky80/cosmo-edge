...
- Ascend 310P3 configuration validates the external CANN toolkit (AscendCL/DVPP headers and x86_64 libraries) and the system FFmpeg at configure time, without committing CANN, driver, firmware, or custom FFmpeg binaries.

...
enum StatusCode {
    ...
    // ascend
    COSMO_NN_ERR_ASCEND_INIT = 0xB000,
    COSMO_NN_ERR_ASCEND_DEVICE,
    COSMO_NN_ERR_ASCEND_CONTEXT,
    COSMO_NN_ERR_ASCEND_STREAM,
    COSMO_NN_ERR_ASCEND_LOAD,
    COSMO_NN_ERR_ASCEND_QUERY,
    COSMO_NN_ERR_ASCEND_MEM,
    COSMO_NN_ERR_ASCEND_MEMCPY,
    COSMO_NN_ERR_ASCEND_EXECUTE,
